        ...
        return (
            <Panel id={this.props.id}>
                ...
                <Group title="Исходный код">
                    <Div>
                        Исходный код доступен на <Link href="https://github.com/rinatsp/zadenujkoy/branches"
                                                       target="_blank">GitHub</Link>.
                        <br/>
                        <br/>
                        Документация <Link href="https://vk.com/dev/vk_apps_docs" target="_blank">VK Apps
                        платформы</Link>.
                    </Div>
                </Group>
